...
![PPCA generative process]({{ site.url }}/images/ppca.png description = "Generative process for factor analysis.<sup>[^2]</sup>")



<sup>[^1]</sup>: I like Liam Neeson, stop judging me. 
<sup>[^2]</sup>: Figure taken from p. 382 of Machine Learning: A Probabilistic Perspective by Kevin Murphy